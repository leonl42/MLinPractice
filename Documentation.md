...
2. [Preprocessing](#Preprocessing)
    - [Labeling](##Labeling the data)
    - [Splitting](##Splitting the data)
    - [Timedeltas](##Timedeltas)
    - [Removing](##Removing Hashtags)
    - [Punctuation Remover](##Punctuation Remover)
    - [Lowercase](##Lowercase)
    - [Abbrevation replacement](##Abbrevation replacement)
    - [Tokenization](##Tokenization)
    - [Stopword](##Stopword removal)
    - [Part](##Part of speech tagging)
    - [Lemmatization](##Lemmatization)
3. [Feature Extraction](#Feature Extraction)
    - [Hashtags](##Hashtags and timedeltas)
    - [ngrams](##ngrams and character length)
4. [Dimensionality](#Dimensionality Reduction)
...
6. [Classification](#Classification)
    - [Majority](##Majority vote classifier)
